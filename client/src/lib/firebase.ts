...
const firebaseConfig = {
  ...
  authDomain: import.meta.env.VITE_FIREBASE_AUTH_DOMAIN || "escuadron404-demo.firebaseapp.com",
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || "escuadron404-demo",
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || "escuadron404-demo.appspot.com",
