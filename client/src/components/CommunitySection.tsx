    ...
    <section className="bg-mesh min-h-screen pt-24" id="comunidad">
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            <p className="text-xl md:text-2xl mb-12 text-gray-300 leading-relaxed max-w-3xl mx-auto">
              Comunidad de desarrolladores apasionados por la tecnología, donde
              el error 404 se convierte en oportunidad de crecimiento
            </p>
          </div>
          <div
            className="animate-slide-up opacity-0"
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Construimos el futuro del desarrollo con pasión, conocimiento y
            colaboración
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="black-card-enhanced rounded-3xl p-8 text-center hover-lift group">
            ...
            <p className="text-gray-300 leading-relaxed">
              Trabajamos juntos en proyectos open source, compartimos
              conocimiento y construimos soluciones que impactan
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed">
              Conectamos desarrolladores senior con junior para acelerar el
              aprendizaje y crear vínculos duraderos
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed">
              Organizamos meetups, hackathons y charlas técnicas que inspiran y
              conectan a la comunidad tech
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Innovaciones que nacen de la colaboración y el talento de nuestra
            comunidad
          </p>
        </div>
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="black-card-enhanced rounded-3xl p-12 max-w-4xl mx-auto text-center">
          ...
          <blockquote className="text-2xl md:text-3xl font-light text-gray-200 mb-8 leading-relaxed">
            "Escuadrón 404 transformó mi carrera como desarrollador. La
            comunidad es increíble, siempre hay alguien dispuesto a ayudar y los
            proyectos colaborativos me han permitido crecer exponencialmente."
          </blockquote>
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="glass-card rounded-3xl p-12 text-center bg-gradient-to-br from-purple-900/20 to-blue-900/20">
          ...
          <p className="text-xl mb-12 text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Conecta con más de 1,000 desarrolladores de toda Latinoamérica y
