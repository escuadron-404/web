import { CheckCircle, Layers, Mail, Star, Users } from "lucide-react";
    ...
    <section className="bg-black min-h-screen pt-24" id="corporativo">
      ...
      <div className="bg-gradient-to-br from-black via-purple-900 to-black py-20">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-8 text-white leading-tight">
            Soluciones{" "}
            <span className="text-gradient-purple">Corporativas</span>
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-gray-200 leading-relaxed max-w-3xl mx-auto">
            Potencia tu equipo con talento especializado de nuestra comunidad de
            desarrolladores élite
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="black-card-enhanced rounded-3xl p-10 text-center hover-lift">
            ...
            <p className="text-gray-300 mb-8 leading-relaxed text-lg">
              Amplía tu equipo con desarrolladores especializados que se
              integran perfectamente a tu cultura organizacional y metodologías
              de trabajo.
            </p>
          ...
          <div className="black-card-enhanced rounded-3xl p-10 text-center hover-lift">
            ...
            <p className="text-gray-300 mb-8 leading-relaxed text-lg">
              Desarrollamos soluciones completas trabajando como una extensión
              natural de tu equipo interno con metodologías ágiles.
            </p>
            <div className="space-y-4">
              {[
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            De la idea a la implementación en 4 pasos simples
          </p>
        </div>
            ...
            {[
              {
                ...
                title: "Consulta",
                description:
                  "Conversamos sobre tus necesidades, objetivos y requisitos específicos del proyecto",
              ...
              },
              {
                ...
                title: "Propuesta",
                description:
                  "Diseñamos una solución personalizada con timeline, recursos y estimaciones detalladas",
              ...
              },
              {
                ...
                title: "Selección",
                description:
                  "Elegimos el talento perfecto de nuestra comunidad basado en skills y experiencia",
              ...
              },
              {
                ...
                title: "Ejecución",
                description:
                  "Comenzamos el desarrollo con sprints ágiles y comunicación constante",
                gradient: "from-orange-500 to-red-500",
              },
            ].map((step, index) => (
              <div
                key={index}
                className="black-card-enhanced rounded-2xl p-8 text-center hover-lift"
              >
                <div
                  className={`bg-gradient-to-br ${step.gradient} w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 text-2xl font-bold text-white`}
                >
                  {step.number}
                </div>
                <h3 className="text-xl font-bold mb-3 text-gradient-purple">
                  {step.title}
                </h3>
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Conoce a algunos de los desarrolladores élite de nuestra comunidad
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            ...
            <div
              key={index}
              className="black-card-enhanced rounded-3xl p-8 text-center hover-lift"
            >
              <div
                className={`w-32 h-32 bg-gradient-to-br from-purple-500 to-blue-600 rounded-full mx-auto mb-6 ring-4 ring-purple-500/30 animate-float flex items-center justify-center`}
                style={{ animationDelay: talent.delay }}
              >
                <Users className="w-16 h-16 text-white" />
              </div>
              <h3 className="text-2xl font-bold mb-2 text-gradient-purple">
                {talent.name}
              </h3>
              ...
              <div className="flex flex-wrap justify-center gap-2 mb-6">
                {talent.skills.map((skill, skillIndex) => (
                  <span
                    key={skillIndex}
                    className="bg-gradient-to-r from-blue-500 to-blue-600 text-white text-xs px-3 py-1 rounded-full font-medium"
                  >
                    {skill}
                  </span>
                ))}
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
                {index === 0 &&
                  "8+ años desarrollando arquitecturas escalables y liderando equipos en proyectos enterprise"}
                {index === 1 &&
                  "Especialista en automatización cloud con experiencia en AWS, Azure y Google Cloud Platform"}
                {index === 2 &&
                  "Experto en desarrollo móvil multiplataforma con más de 50 apps publicadas en stores"}
              </p>
              <div className="flex justify-center space-x-3">
                ...
                <span className={`text-sm font-medium ${talent.statusColor}`}>
                  {talent.status}
                </span>
              </div>
            </div>
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            ¿Listo para potenciar tu equipo? Contáctanos y recibe una propuesta
            personalizada
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <form
            ...
            className="black-card-enhanced rounded-3xl p-10"
          >
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="md:col-span-2">
                ...
                >
                  ...
                  <option value="proyecto-colaborativo">
            ...
            <div className="mt-8 pt-6 border-t border-gray-700">
              <div className="flex items-center mb-6">
                ...
                <label htmlFor="terms" className="ml-3 text-sm text-gray-300">
                  ...
                  y autorizo el procesamiento de mis datos
                </label>
              </div>
              <button
                type="submit"
