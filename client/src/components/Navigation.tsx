...
export default function Navigation({
  ...
  return (
    <nav
      className={`glass fixed w-full top-0 z-50 transition-all duration-300 border-b border-purple-500/20 ${isScrolled ? "bg-black/95" : "bg-black/10"}`}
    >
