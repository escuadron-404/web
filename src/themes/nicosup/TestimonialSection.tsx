...
const TestimonialCard: FC<TestimonialCardProps> = ({
  ...
  return (
    <div className=" rounded-xl p-8 text-center h-full flex flex-col justify-between border hover:shadow-xl  hover:shadow-emerald-300/50 transition-shadow duration-300">
      <div className="mb-6">
...
const N98TestimonialSection: FC<TestimonialSectionProps> = ({
  testimonials,
  error,
}) => {
  return (
...
export default N98TestimonialSection;
