...
const N98ProjectsSection: FC<ProjectsSectionProps> = ({
  heading,
  subheading,
  projects,
  error,
      ...
      {!error && projects.length > 0 && (
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {projects.map((project) => (
            <div
              key={project.title}
              className="border border-foreground rounded-xl p-8 hover:shadow-xl hover:shadow-emerald-300/50 hover:-translate-y-1/8 transition-transform  transition-shadow duration-300"
            >
...
export default N98ProjectsSection;
