    ...
    <div className="bg-mesh min-h-screen pt-24 flex items-center justify-center">
      <div className="container mx-auto px-6 py-20">
        <div className="animate-slide-up text-center max-w-5xl mx-auto">
          ...
          <Link
            href={ctaLink}
            className="bg-primary text-primary-foreground  font-bold py-4 px-10 rounded-lg text-lg transition-all duration-100 hover:border shadow-md hover:shadow-lg"
