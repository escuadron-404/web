...
const N98ContactForm: FC<ContactFormProps> = ({
  heading,
  subheading,
  fields,
  onSubmit,
    ...
    <div className="container mx-auto px-6 py-20">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-primary border text-primary-foreground font-bold py-4 px-6 rounded-xl transition-all duration-300 hover:scale-[1.02] shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
